...
do_pgfault(struct mm_struct *mm, uint32_t error_code, uintptr_t addr) {
    ...
    *    page_insert 锛�build the map of phy addr of an Page with the linear addr la
    *    swap_map_swappable 锛�set the page swappable
    */
    /*
     ...
     */
        if(swap_init_ok) {
            struct Page *page=NULL;
                                    //(1锛堿ccording to the mm AND addr, try to load the content of right disk page
